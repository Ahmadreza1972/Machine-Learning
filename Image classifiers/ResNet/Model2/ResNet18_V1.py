...
def main():
    ...
    train_path = r"Image classifiers\ResNet\Model2\model2_test.pth"  
    test_path = r"Image classifiers\ResNet\Model2\model2_test.pth"
    save_path= r"Image classifiers\ResNet\Model2\model_weights2.pth"
    batch_size = 16
    learning_rate = 0.001
    epoch = 35
    valdata_ratio=0.1
